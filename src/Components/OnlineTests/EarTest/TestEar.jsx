...
export default function TestEar() {
    const questions = [
        {
            questionText: 'Прежде, чем мы начнем, нам нужно узнать ваш пол и возраст, а также убедиться, правильно ли отрегулирована громкость на вашем устройстве, Найдите тихое место, где бы вы могли спокойно пройти тест, Выберите, что вы будете использовать: динамики вашего устройства или наушники, Наушники обеспечивают более высокую точность результатов и позволяют протестировать правое и левое ухо по отдельности, Убедитесь, что звук на устройстве не выключен и установлен на комфортном для вас уровне.',
            answerOptions: [
                { answerText: 'далее', isCorrect: true }
            ],
        },
        {
